---
document_id: ATC-DOC-SHIVACORE-CONTRIB-001
title: Contributing Guidelines - atc-shivacore
version: 1.0.0
status: active
...
# Contributing to atc-shivacore

## Beitragsrichtlinien

Vielen Dank für Ihr Interesse an Beiträgen zu `atc-shivacore` im A-TownChain-Ökosystem.
