...
---
document_id: ATC-DOC-SHIVACORE-AGENTS-001
title: AI Agent Instructions - atc-shivacore
version: 1.0.0
status: active
...
# AI Agent Instructions — atc-shivacore
...
- **ATC-STD-REPO-MAINT-001:** Maintenance Lifecycle Standard
...
3. `ARCHITECTURE.md` — Microkernel architecture & design rules
...
3. Perform implementation or bug fixes in Rust code (`modules/`).
4. Execute full test suite: `cargo test --workspace`.
